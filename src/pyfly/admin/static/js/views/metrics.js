/**
 * PyFly Admin — Metrics View (stub).
 *
 * Displays application metrics with charts and drill-down.
...
export async function render(container, api) {
    ...
    t.textContent = 'Metrics view will be implemented in a subsequent task.';
    body.appendChild(t);
