...
<p align="center">
  ...
  <a href="#"><img src="https://img.shields.io/badge/version-0.2.0--M3-yellow" alt="Version: 0.2.0-M3"></a>
...
pip install "pyfly @ https://github.com/fireflyframework/pyfly/releases/latest/download/pyfly-0.2.0a3-py3-none-any.whl"

# Install with specific extras
pip install "pyfly[web,data-relational,cache] @ https://github.com/fireflyframework/pyfly/releases/latest/download/pyfly-0.2.0a3-py3-none-any.whl"

# Or with uv
uv pip install "pyfly @ https://github.com/fireflyframework/pyfly/releases/latest/download/pyfly-0.2.0a3-py3-none-any.whl"
```
...
| **Milestone** | `0.2.0-M3` | Pre-release feature preview. New functionality available for early feedback. |
...
For Python packaging (PEP 440), milestone versions map to alpha pre-releases (`0.2.0a3`), release candidates map to `rc` (`0.2.0rc1`), and GA is the final release (`0.2.0`). See [docs/versioning.md](docs/versioning.md) for full details.
...
**Current:** 0.2.0-M3 (2026-02-18) — Clean server startup output (Spring Boot parity), graceful shutdown across all subsystems, enhanced admin dashboard wallboard (9 tiles, 3x3), bean dependency graph with search/filter/detail panel, strict mypy decorator typing.
