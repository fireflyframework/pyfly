...
<p align="center">
  ...
  <a href="#"><img src="https://img.shields.io/badge/version-0.2.0--M1-yellow" alt="Version: 0.2.0-M1"></a>
...
pip install "pyfly @ https://github.com/fireflyframework/pyfly/releases/latest/download/pyfly-0.2.0a1-py3-none-any.whl"

# Install with specific extras
pip install "pyfly[web,data-relational,cache] @ https://github.com/fireflyframework/pyfly/releases/latest/download/pyfly-0.2.0a1-py3-none-any.whl"

# Or with uv
uv pip install "pyfly @ https://github.com/fireflyframework/pyfly/releases/latest/download/pyfly-0.2.0a1-py3-none-any.whl"
```
...
| **Milestone** | `0.2.0-M1` | Pre-release feature preview. New functionality available for early feedback. |
...
For Python packaging (PEP 440), milestone versions map to alpha pre-releases (`0.2.0a1`), release candidates map to `rc` (`0.2.0rc1`), and GA is the final release (`0.2.0`). See [docs/versioning.md](docs/versioning.md) for full details.
